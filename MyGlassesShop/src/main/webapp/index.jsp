		...
		<div class="main">
						...
						<div class="pager">
							...
							<ul class="dc_pagination dc_paginationA dc_paginationA06">
								...
								<c:forEach begin="1" end="${map.totalPage }" var="nowPage">
									<a href="/MyGlassesShop/showGlasses?nowPage=${nowPage}">${nowPage }</a>
								</c:forEach>
							</ul>
							<div class="clear"></div>
						</div>
			...
			<div class="rsidebar span_1_of_left">
				...
				<div class="col col-4">
					...
					<ul><a href="/MyGlassesShop/brandSelect?brand=${brand.id}"><h2 class="m_2">${brand.brand}</h2></a></ul>	
					</c:forEach>
				</div>
				</section>
				<section class="sky-form">
				...
				<div class="col col-4">
					...
					<ul><a href="/MyGlassesShop/materialSelect?material=${material.id}"><h2 class="m_2">${material.material}</h2></a></ul>	
					</c:forEach>
				</div>
				</section>
				<section class="sky-form">
				...
				<div class="col col-4">
					...
					<ul><a href="/MyGlassesShop/colorSelect?color=${color.id}"><h2 class="m_2">${color.color}</h2></a></ul>	
					</c:forEach>
				</div>
				</section>
			</div>
